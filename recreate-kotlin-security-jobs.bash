...
function get_yaml() {
  yml_file=$1
  gh api repos/ministryofjustice/hmpps-template-kotlin/contents/.github/workflows/$yml_file -H "Accept: application/vnd.github.v3.raw" > .github/workflows/$yml_file
}
