...
This contains a library of reusable Github workflows for use by other projects. These include:
...
Workflows are referred to by the SHA of the current release, with a comment referring to the tag, eg:
